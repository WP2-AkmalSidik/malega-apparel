...
export default function StoreHomePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-5 space-y-3.5">
      ...
      {/* 2. Sleek Compact Search & Filter Toolbar (1 Single Flexible Row) */}
      <div className="flex items-center gap-2">
        ...
        {/* Sort Select (Desktop Only Direct, Mobile in Filter Modal or compact) */}
        ...
        {/* Filter Trigger Button (Opens Bottom Sheet / Modal) */}
        <button
      ...
      {/* 3. Horizontal Category Carousel Tabs (Scrollable on Mobile) */}
      ...
      {/* 4. Active Applied Filter Tags (Only Appears When Filters Active) */}
        ...
        <div className="flex items-center gap-1.5 flex-wrap text-[10px] text-[#94A3B8] pt-0.5">
          ...
          {sortBy !== 'featured' && (
            <span className="inline-flex items-center gap-1 bg-[#14204A] border border-[#CBAC70]/30 text-[#CBAC70] px-2 py-0.5 rounded-lg">
              ...
              <button onClick={() => setSortBy('featured')} className="hover:text-white">✕</button>
            </span>
          )}

          <button
            onClick={handleResetFilters}
            className="text-[10px] text-[#94A3B8] hover:text-[#CBAC70] underline ml-1"
          >
            Reset Semua
          </button>
        </div>
      ...
      {/* 5. Product Catalog Listing (2-Column Mobile First & 3-4 Col Desktop) */}
