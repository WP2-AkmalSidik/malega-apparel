        ...
        <div class="flex flex-col flex-1 min-h-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <a 
                    ...
                    class="flex items-center gap-3 px-3 py-2.5 rounded-md {{ request()->routeIs('inventory*') ? 'bg-gold/10 border-l-2 border-gold text-ivory font-medium' : 'text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors' }}"
                >
                ...
                <a 
                    ...
                    class="flex items-center gap-3 px-3 py-2.5 rounded-md {{ request()->routeIs('customers*') ? 'bg-gold/10 border-l-2 border-gold text-ivory font-medium' : 'text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors' }}"
                >
