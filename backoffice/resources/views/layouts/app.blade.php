    ...
    >
        <div class="flex flex-col flex-1 min-h-0">
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                ...
                <!-- Ulasan & Rating -->
                <a 
                    href="{{ route('catalog.reviews') }}" 
                    class="flex items-center gap-2.5 px-3 py-2 rounded-md {{ request()->routeIs('catalog.reviews*') ? 'bg-gold/10 border-l-2 border-gold text-ivory font-medium' : 'text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors' }}"
                >
                    <svg class="w-4 h-4 {{ request()->routeIs('catalog.reviews*') ? 'text-gold' : 'text-ivory/60' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                    </svg>
                    <span class="text-xs">Ulasan & Rating</span>
                </a>
                ...
                <a 
                    ...
                    class="flex items-center gap-2.5 px-3 py-2 rounded-md {{ request()->routeIs('customers.index') ? 'bg-gold/10 border-l-2 border-gold text-ivory font-medium' : 'text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors' }}"
                >
                    <svg class="w-4 h-4 {{ request()->routeIs('customers.index') ? 'text-gold' : 'text-ivory/60' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                ...
                <a 
                    ...
                    class="flex items-center gap-2.5 px-3 py-2 rounded-md {{ request()->routeIs('customers.tiers*') ? 'bg-gold/10 border-l-2 border-gold text-ivory font-medium' : 'text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors' }}"
                >
                    <svg class="w-4 h-4 {{ request()->routeIs('customers.tiers*') ? 'text-gold' : 'text-ivory/60' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                    </svg>
                    <span class="text-xs">Tingkatan Member</span>
                </a>
                ...
                <!-- GRUP MARKETING & PROMOSI -->
                <p class="px-3 pt-5 mb-1.5 text-[9px] font-semibold tracking-[0.2em] text-gold uppercase font-mono">Pemasaran</p>

                <!-- Voucher & Promo -->
                <a 
                    href="{{ route('marketing.vouchers') }}" 
                    class="flex items-center gap-2.5 px-3 py-2 rounded-md {{ request()->routeIs('marketing.vouchers*') ? 'bg-gold/10 border-l-2 border-gold text-ivory font-medium' : 'text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors' }}"
                >
                    <svg class="w-4 h-4 {{ request()->routeIs('marketing.vouchers*') ? 'text-gold' : 'text-ivory/60' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
