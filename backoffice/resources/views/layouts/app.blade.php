    ...
    >
        <div class="flex flex-col flex-1 min-h-0">
            ...
            <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto">
                ...
                <p class="px-3 pt-5 mb-1.5 text-[9px] font-semibold tracking-[0.2em] text-ivory/40 uppercase font-mono">Lainnya</p>

                <!-- Laporan -->
                <a 
                    href="#" 
                    class="flex items-center gap-2.5 px-3 py-2 rounded-md text-ivory/60 hover:bg-white/5 hover:text-ivory transition-colors"
                >
